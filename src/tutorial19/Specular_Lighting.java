...
public class Specular_Lighting implements GLEventListener {

    public Specular_Lighting(Camera camera) {
        this.camera = camera;
        camera.light = light;
        light.ambientIntensity = 0.0f;
        light.color = new float[]{1f, 1f, 1f};
        light.diffuseIntensity = 0.2f;
        light.direction = new float[]{0, 0, 1};
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Specular Lighting");
        ...
        canvas.addGLEventListener(new Specular_Lighting(camera));
...
//        gl.glUniform1i(gSampler, 0);
        ...
        try {
            ...
            Logger.getLogger(Specular_Lighting.class.getName()).log(Level.SEVERE, null, ex);
...
//        System.out.printf("Camera up:%s%n",camera.up);
        ...
        effect.setMatSpecularIntensity(1.0f);
        effect.setMatSpecularPower(32);
...
//        gl.glUniformMatrix4fv(gWVPLocation, 1, true, World, 0);
    ...
    private void initVertex(GL4 gl, int[] index) {
//        float[] data = {
