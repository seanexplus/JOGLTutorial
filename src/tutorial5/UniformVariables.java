...
public class UniformVariables implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Uniform Variable");
        ...
        canvas.addGLEventListener(new UniformVariables());
...
//        animator.add(canvas);
    ...
    private void render(GLAutoDrawable drawable) {
        ...
        gl.glUniform1f(gScaleLocation, (float)Math.sin(Scale));
    ...
    private String[] readShader(String path) {
        ...
        try {
            ...
            Logger.getLogger(UniformVariables.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                is.close();
            } catch (IOException ex) {
    ...
    private void compileShader(GL4 gl) {
        ...
        gScaleLocation = gl.glGetUniformLocation(ShaderProgram, "gScale");
