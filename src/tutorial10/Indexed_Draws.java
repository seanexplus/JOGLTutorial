...
public class Indexed_Draws implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Indexed Draws");
        ...
        canvas.addGLEventListener(new Indexed_Draws());
...
//        gl.glDrawArrays(GL2.GL_TRIANGLES, 0, 3);
    ...
    private String[] readShader(String path) {
        ...
        try {
            ...
            Logger.getLogger(Indexed_Draws.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                is.close();
            } catch (IOException ex) {
