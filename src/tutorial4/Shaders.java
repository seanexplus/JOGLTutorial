...
public class Shaders implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Shaders");
        ...
        canvas.addGLEventListener(new Shaders());
...
//        animator.add(canvas);
    ...
    private String[] readShader(String path) {
        ...
        try {
            ...
            Logger.getLogger(Shaders.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                is.close();
            } catch (IOException ex) {
