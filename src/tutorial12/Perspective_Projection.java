...
public class Perspective_Projection implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        canvas.addGLEventListener(new Perspective_Projection());
...
//        animator.add(canvas);
    ...
    private void render(GLAutoDrawable drawable) {
        ...
        p.setPerspectiveProj(30f, drawable.getWidth(), drawable.getHeight(), 1, 1000);
...
//        gl.glDrawArrays(GL2.GL_TRIANGLES, 0, 3);
    ...
    private String[] readShader(String path) {
        ...
        try {
            ...
            Logger.getLogger(Perspective_Projection.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                is.close();
            } catch (IOException ex) {
