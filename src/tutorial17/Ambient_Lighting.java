...
public class Ambient_Lighting implements GLEventListener {

    public Ambient_Lighting(Camera camera) {
        this.camera = camera;
        camera.light = light;
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Ambient Lighting");
        ...
        canvas.addGLEventListener(new Ambient_Lighting(camera));
...
//        gl.glUniform1i(gSampler, 0);
        ...
        try {
            ...
            Logger.getLogger(Ambient_Lighting.class.getName()).log(Level.SEVERE, null, ex);
