...
public class Diffuse_Lighting implements GLEventListener {

    public Diffuse_Lighting(Camera camera) {
        this.camera = camera;
        camera.light = light;
        light.ambientIntensity = 0.1f;
        light.color = new float[]{1f, 1f, 1f};
        light.diffuseIntensity = 0.75f;
        light.direction = new float[] { 1,0,0};
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Diffuse Lighting");
        ...
        canvas.addGLEventListener(new Diffuse_Lighting(camera));
...
//        gl.glUniform1i(gSampler, 0);
        ...
        try {
            ...
            Logger.getLogger(Diffuse_Lighting.class.getName()).log(Level.SEVERE, null, ex);
