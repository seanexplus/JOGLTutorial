...
public class Translation_Transformation implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Translation Transformation");
        ...
        canvas.addGLEventListener(new Translation_Transformation());
...
//        FloatBuffer World = FloatBuffer.allocate(9);
        float[] World = {1f, 0f, 0f, (float) Math.sin(Scale),
            0f, 1f, 0f, 0f,
            0f, 0f, 1f, 0f,
            0f, 0f, 0f, 1f};
    ...
    private String[] readShader(String path) {
        ...
        try {
            ...
            Logger.getLogger(Translation_Transformation.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                is.close();
            } catch (IOException ex) {
