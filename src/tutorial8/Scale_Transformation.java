...
public class Scale_Transformation implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Scale Transformation");
        ...
        canvas.addGLEventListener(new Scale_Transformation());
...
//        FloatBuffer World = FloatBuffer.allocate(9);
    ...
    private String[] readShader(String path) {
        ...
        try {
            ...
            Logger.getLogger(Scale_Transformation.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                is.close();
            } catch (IOException ex) {
