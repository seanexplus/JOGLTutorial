...
public class Camera_Control2 implements GLEventListener {

    public Camera_Control2(Camera camera) {
        this.camera = camera;
    }
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Camera Control 2");
        ...
        canvas.addGLEventListener(new Camera_Control2(camera));
...
//        gl.glDrawArrays(GL2.GL_TRIANGLES, 0, 3);
    ...
    private String[] readShader(String path) {
        ...
        try {
            ...
            Logger.getLogger(Camera_Control2.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                is.close();
            } catch (IOException ex) {
